            ...
            if (userPath.compareTo("/accountCreation") == 0) {
                ...
                try {
                    if (creation.canMake()) {
                        ...
                        //    out.println("<h2>A moderator named "
                        //            + creation.getUsername() + " is just created.</h2>");
                        // } else if (creation.getPassPhrase().compareTo(creation.ADMINISTRATOR_STRING) == 0) {
                        //     out.println("<h2>An administrator named "
                        //             + creation.getUsername() + " is just created.</h2>");
                        // } else {
                        //     throw new IllegalStateException("Bad request found.");
                        // }
                        out.println("<h3>Account successfully created.<br>You can login below.</h3>");
                        makeLoginPage(out);
                    } else {
